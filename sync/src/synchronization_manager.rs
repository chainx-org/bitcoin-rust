        ...
        ManagementWorker {
            ...
            thread: Some(
                thread::Builder::new()
                    ...
                    .spawn(move || {
                        ManagementWorker::worker_proc(is_stopping, stopping_event, core)
                    })
...
mod tests {
    ...
    use super::{ManagePeersConfig, ManageUnknownBlocksConfig, ManageOrphanTransactionsConfig,
                manage_synchronization_peers_blocks, manage_unknown_orphaned_blocks,
                manage_orphaned_transactions};
    use utils::{OrphanBlocksPool, OrphanTransactionsPool};
