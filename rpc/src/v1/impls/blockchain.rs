    ...
    fn verbose_block(&self, hash: GlobalH256) -> Option<VerboseBlock> {
        self.storage.block(hash.into()).map(|block| {
            ...
            VerboseBlock {
                ...
                nextblockhash: height.and_then(
                    |h| self.storage.block_hash(h + 1).map(|h| h.into()),
                ),
    ...
    T: BlockChainClientCoreApi,
{
    ...
    fn block(&self, hash: H256, verbose: Trailing<bool>) -> Result<GetBlockResponse, Error> {
        ...
        if verbose.unwrap_or_default() {
            ...
            self.core.raw_block(global_hash.reversed()).map(|block| {
                GetBlockResponse::Raw(block)
            })
        ...
        fn verbose_block(&self, _hash: GlobalH256) -> Option<VerboseBlock> {
            ...
            Some(VerboseBlock {
                ...
                merkleroot: "d5fdcc541e25de1c7a5addedf24858b8bb665c9f36ef744ee42c316022c90f9b"
                    .into(),
                tx: vec![
                    "d5fdcc541e25de1c7a5addedf24858b8bb665c9f36ef744ee42c316022c90f9b".into(),
                ],
                time: 1231469744,
                mediantime: None,
                nonce: 1639830024,
        ...
        assert_eq!(
            ...
            Some(VerboseBlock {
                ...
                merkleroot: "982051fd1e4ba744bbbe680e1fee14677ba1a3c3540bf7b1cdb606e857233e0e"
                    .into(),
                tx: vec![
                    "982051fd1e4ba744bbbe680e1fee14677ba1a3c3540bf7b1cdb606e857233e0e".into(),
                ],
                time: 1231469665,
